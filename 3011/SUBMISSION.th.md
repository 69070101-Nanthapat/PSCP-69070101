...
```text
input รับค่าสีเข้ามา 2 สีแล้วก็เอามาเทียบกับเงื่อนไขว่าผสมกันแล้วได้เป็นอะไร output ได้สีที่ผสมกัน
```
...
```text
Step 1:รับค่าสี
Step 2:สร้างเงื่อนไขให้ output ออกมาเป็นสีที่ผสมกัน
Step 3:print output
```
...
```text
ทำเหมือนวิธีที่กล่าวไปแต่เพิ่มเติมตรงเงื่อนไขให้มีเงื่อนไขที่สีสลับลำดับกันและสีเดียวกันผสมกันด้วย
```
...
```text
เพราะไม่มีในเคสตัวอย่างและสลับตำแหน่งกับอันเมื่อกี้
```
