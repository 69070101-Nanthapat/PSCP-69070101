...
```text
รับเดือนกับวันมาแล้วก็เอาไปเข้าตามเงื่อนไขว่าเป็นฤดูไหน
```
...
```text
step 1 รับค่าเดือนกับวัน
step 2 สร้างเงื่อนไขว่าถ้าอยู่ในเดือนนี้ๆ ให้เป็นฤดูนี้
เช่น if month in (10, 11, 12)
                 print("fall")
step 3 เพิ่มเงื่อนไขวัน
if month in (10, 11, 12) or (month == 9 and day >= 21):
          print("fall")
```
...
```text
ใบ้ว่าโค้ดยังไม่ครอบคุมเงื่อนไขตรงไหน
```
