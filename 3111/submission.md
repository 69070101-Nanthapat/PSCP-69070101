...
```text
input รับสถานะสหกรณ์ จำนวนสินค้า ราคาสินค้าตามจำนวนที่ซื้อ
output ราคารวมหลังลดค่าสมาชิก หรือ ยอกรวม >= 500
```
...
```text
step1 รับสถานะสหกรณ์ Y N
step2 รับจำนวนสินค้าที่ซื้อ
step3 loop ตามจำนวนของที่ซื้อ
step4 รับราคาของที่ซื้อแล้วให้ += ไปใน total
step5 สร้างเงื่อนไขเช็ตว่าเป็นสมาชิกมั้ยหรือมาก>= 500 มั้ย แล้วคำนวนราคา
step6 printผลลัพธ์:.2f
```
