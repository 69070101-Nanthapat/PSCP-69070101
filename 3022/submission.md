...
```text
รับอุณหภูมิเข้ามาแล้วให้เลือกว่าจะเปลี่ยนจากอะไรเป็นอะไรผลลัพธ์เป็นค่าอุณหภูมิในหน่วยที่เลือก
```
...
```text
step1 รับค่าอุณหภูมิเข้ามากับหน่วยอุณหภูมิสองอัน
step2 เขียนเงื่อไขโดยอิงจากสูตรที่ให้มา
```
...
```text
เพราะเป็นเงื่อนไขที่ผมลืมนึกถึงในตอนแรก
```
...
```text
ใบ้ว่าเงื่อนไขยังไ่ม่ครอบคลุมตรงไหน
```
