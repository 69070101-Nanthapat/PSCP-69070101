...
```text
input จำนวนเงิน output เป็นเงินรวมที่ต้องจ่าย ข้อจำกัดคือการมีขั้นต่ำ50ในการบวกและไม่เกิน1000ของการบวก service charge
```
...
```text
Step 1:รับค่าจำนวนเงิน
Step 2:หาค่าบริการ 10% ก่อน แล้ววางเงื่อนไขให้มีขั้นต่ำกับmaxที่1000 แล้วค่อยเอามาบวก vat 7%
Step 3:print เงินที่ต้องจ่ายทั้งหมด
```
...
```text
ทำเหมือนวิธีข้างบนแต่ตอนแรกที่ทำลืมเขียนเงื่อนไขที่บวกสุดแค่ 1000
```
