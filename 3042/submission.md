...
```text
input รับเลขจำนวนเต็มมา 1
output แสดงตัวเลขที่หารด้วย 10 ลงตัว
```
...
```text
step1 รับค่า num และวนลูปถอยหลังตั้งแต่ num ลงไปถึง 0
step2 เช็กเงื่อนไข if not i % 10:
step3 พิมพ์ค่าออกมาคั่นด้วยช่องว่าง ใช้ end=" "
```
