...
goal c
output
จำนวนอิฐก้อนเล็กที่ต้องใช้ ถ้าสร้างไม่ได้ก็ -1
```
...
```text
step1 หาว่าต้องใช้ก้อนใหญ่กี่ก้อน
step2 คำนวนก้อนเล็กที่ต้องเอามาเติม
step3 ดูว่าก้อนเล็กพอมั้ยถ้าสร้างไม่ได้ให้เป็น -1
step4 print ก้อนเล็กที่ต้องใช้
```
...
```text
เพราะลองให้ goal เป็น 0 และ ไม่มีใน case ตัวอย่าง
```
