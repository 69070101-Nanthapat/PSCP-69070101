...
```text
input จํานวนร้าน และ จํานวนช่วงเวลาที่ต้องตรวจสอบ
output จำนวนร้านที่เปิดอยู่ในเวลานั้นๆ
```
...
```text
step1 จํานวนร้าน และ จํานวนช่วงเวลาที่ต้องตรวจสอบ
step2 loop วนรับเวลาร้านค้าทีละร้าน
step3 loop ใน loop step2 อีกที วนบวกเลขเพิ่มทีละ 1 ตั้งแต่นาทีที่เริ่มเปิดจนถึงก่อนเวลาปิด 1 นาที
step4 print จำนวนร้านที่เปิดอยู่ในเวลานั้นๆ
