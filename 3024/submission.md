...
```text
รับค่า รวม กับ สูงสุด
หาค่า min แล้วเอาไปเปรียบเทียบในเงื่อนไข
output บอกว่ามีการอวยหรือไม่อวย
```
...
```text
step1 รับค่า รวม กับ สูงสุด
step2 หาค่า min แล้วเอาไปเปรียบเทียบในเงื่อนไข
print
```
