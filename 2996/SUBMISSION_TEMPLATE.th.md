...
```text
สร้างตัวแปรรับคำเข้ามา สร้างตัวแปรมารับค่าของอันแรกที่เปลี่ยนเป็นพิมพ์เล็กโดยใช้ .lower() print ออกมาโดยมี [::-1] ต่อหลังให้มันพิมพ์ข้อความออกมาแบบกลับหลัง output ที่ออกมาจะเป็นคำที่รับเข้ามากลับหลังและเป็นตัวพิมพ์เล็ก
```
...
```text
Step 1:รับค่า
Step 2:เปลี่ยนให้เป็นพิมพ์เล็ก
Step 3:printออกมาแบบกลับด้าน
```
...
```text
เพราะไม่เหมือน test case ตัวอย่าง
```
